...
* Запрос размещен рядом с кодом первого вопроса:
https://github.com/Percimon/ShapeAreaCalculator/blob/master/ProductCategoryQuery.sql

* В запрос включено создание таблиц и тестового набора данных
